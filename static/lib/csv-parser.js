function b(t, n, i = (e) => e) {
  ...
  ((e.options = n || {}), (e.reviver = i), (e.value = ''), (e.entry = []), (e.output = []), (e.col = 1), (e.row = 1));
  let l = /"|,|\r\n|\n|\r|[^",\r\n]+/y,
    a = /^(\r\n|\n|\r)$/,
    u = [],
    o = '',
      ...
      case 2:
        switch (!0) {
          ...
          case a.test(o):
            ...
            break;
          default:
            throw ((r = 4), Error(`CSVError: Illegal state [row:${e.row}, col:${e.col}]`));
        }
        break;
      case 3:
        switch (!0) {
  ...
  return (
    t.forEach((a, u) => {
      ...
      switch (
        ((e.col = 1),
        a.forEach((r, f) => {
          (typeof r == 'string' && ((r = r.replace(/"/g, '""')), (r = l.test(r) ? `"${r}"` : r)),
            (o += i(r, e.row, e.col)),
            f !== a.length - 1 && (o += ','),
            e.col++);
        }),
