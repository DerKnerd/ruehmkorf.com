...
export function setRedirect(redirect) {
  sessionStorage.setItem('/relay/login/redirect', redirect);
}

export function getRedirect() {
  return sessionStorage.getItem('/relay/login/redirect');
}

export function deleteRedirect() {
  sessionStorage.removeItem('/relay/login/redirect');
}

export function hasAccessToken() {
  return !!localStorage.getItem('/relay/api/access-token');
}
...
export function setAccessToken(code) {
  localStorage.setItem('/relay/api/access-token', code);
}

export function deleteAccessToken() {
  localStorage.removeItem('/relay/api/access-token');
}

function setCodeVerifier(code) {
  localStorage.setItem('/relay/login/code-verifier', code);
}

function getCodeVerifier() {
  return localStorage.getItem('/relay/login/code-verifier');
}

function deleteCodeVerifier() {
  localStorage.removeItem('/relay/login/code-verifier');
}
